...
// Builds HTML for the home page based on categories array returned by the server.
function buildAndShowHomeHTML (categories) {
  ...
  $ajaxUtils.sendGetRequest(  homeHtmlUrl,
    function (homeHtml) {
      ...
      // TODO: STEP 3: Substitute {{randomCategoryShortName}} in the homeHtml snippet with the
    ...
    function (categoriesTitleHtml) {
      ...
      $ajaxUtils.sendGetRequest( categoryHtml,
        function (categoryHtml) {  
          switchMenuToActive();				// Switch CSS class active to menu button
